myApp.controller('viewPlaceCtrl', ['$scope', '$http', '$window', '$routeParams', '$location', 'geolocationSvc', 'mapsFactory', 'userFactory', function ($scope, $http, $window, $routeParams, $location, geolocationSvc, mapsFactory, userFactory) {
